...
class getConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setModelFactoryManager(new \Zenstruck\Foundry\ModelFactoryManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 1 => ($container->privates['App\\Factory\\ReviewFactory'] ?? ($container->privates['App\\Factory\\ReviewFactory'] = new \App\Factory\ReviewFactory()));
            yield 2 => ($container->privates['App\\Factory\\UserFactory'] ?? $container->load('getUserFactoryService'));
        }, 3)));
